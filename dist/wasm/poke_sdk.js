 ...
 * @returns {Promise<any>}
 */
export function get_pokemon_wasm(id) {
    const ret = wasm.get_pokemon_wasm(id);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_90fb09e08acc4555 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 39, __wbg_adapter_6);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('poke_sdk_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
